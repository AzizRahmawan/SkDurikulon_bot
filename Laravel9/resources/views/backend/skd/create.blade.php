...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="/dashboard/skd/create/nik" method="GET">
            ...
            <form method="POST" action="{{ route('skd.store') }}" enctype="multipart/form-data">
                @csrf
                @if ($penduduk->isEmpty())
                ...
                @foreach ($penduduk as $p)
                    ...
                    <div class="form-group">
                        <label for="no_kk">No KK</label>
                        <input type="text" class="form-control" name="no_kk" required value="{{$p->no_kk}}">
                    </div>
                    <div class="form-group">
                        <label for="tgl_lahir">Tempat dan Tanggal Lahir</label>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="pekerjaan" required value="{{$p->pekerjaan}}">
                    </div>
                    <div class="form-group">
                        <label for="pendidikan">Status Pernikahan</label>
                        <input type="text" class="form-control" name="status" required value="{{$p->status}}">
                    </div>
                    <div class="form-group">
                        <label for="pendidikan">Agama</label>
                        <input type="text" class="form-control" name="agama" required value="{{$p->agama}}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="alamat">Alamat Pada KTP</label>
                        <textarea name="alamat_ktp" rows="5" class="form-control" required>{{$p->alamat_ktp}}</textarea>
                    </div>
                    <div class="form-group">
                        <label for="alamat">Keterangan Alamat/Tempat Tinggal Sekarang</label>
                        <textarea name="alamat_skr" rows="5" class="form-control" required placeholder="Orang tersebut di atas pada saat ini benar–benar Berdomisili / Bertempat Tinggal di?"></textarea>
                    </div>
                @endforeach
                @endif
