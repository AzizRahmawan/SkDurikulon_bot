...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('req_edit_agama.update',$req_edit_agama->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <div class="row">
                    <div class="col-md">
                        ...
                        <div class="form-group">
                            ...
                            <input type="Text" class="form-control" name="agama_lama" required value="{{ isset($penduduk) ? $penduduk->agama : '' }}">
                        </div>
                    </div>
                    <div class="col-md">
                        ...
                        <div class="form-group">
                            ...
                            <input type="Text" class="form-control" name="nama_user" required value="{{ isset($req_edit_agama) ? $req_edit_agama->nama_user : '' }}" readonly>
                            <input type="hidden" class="form-control" name="nik" required value="{{ isset($req_edit_agama) ? $req_edit_agama->nik_lama : '' }}">
                        </div>
                        <div class="form-group">
                            <label for="nama">AGAMA</label>
                            <input type="Text" class="form-control" name="agama" required value="{{ isset($req_edit_agama) ? $req_edit_agama->agama_baru : '' }}" readonly>
                        </div>
                    </div>
                </div>
                <div class="form-group">
