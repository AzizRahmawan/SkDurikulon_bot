...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('req_edit_pekerjaan.update',$req_edit_pekerjaan->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <div class="row">
                    <div class="col-md">
                        ...
                        <div class="form-group">
                            ...
                            <input type="Text" class="form-control" name="pekerjaan_lama" required value="{{ isset($penduduk) ? $penduduk->pekerjaan : '' }}">
                        </div>
                    </div>
                    <div class="col-md">
                        ...
                        <div class="form-group">
                            ...
                            <input type="Text" class="form-control" name="nama_user" required value="{{ isset($req_edit_pekerjaan) ? $req_edit_pekerjaan->nama_user : '' }}" readonly>
                            <input type="hidden" class="form-control" name="nik" required value="{{ isset($req_edit_pekerjaan) ? $req_edit_pekerjaan->nik_lama : '' }}">
                        </div>
                        <div class="form-group">
                            <label for="nama">PEKERJAAN BARU</label>
                            <input type="Text" class="form-control" name="pekerjaan_baru" required value="{{ isset($req_edit_pekerjaan) ? $req_edit_pekerjaan->pekerjaan_baru : '' }}" readonly>
                        </div>
                    </div>
                </div>
                <div class="form-group">
