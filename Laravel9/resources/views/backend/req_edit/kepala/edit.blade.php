...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('req_edit_kepala.update',$req_edit_kepala->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <div class="row">
                    <div class="col-md">
                        ...
                        <div class="form-group">
                            ...
                            <input type="Text" class="form-control" name="nama_kepala_lama" required value="{{ isset($penduduk) ? $penduduk->nama_kepala : '' }}">
                        </div>
                        <div class="form-group">
                            <label for="nama">NIK KEPALA</label>
                            <input type="Text" class="form-control" name="nik_kepala_lama" required value="{{ isset($penduduk) ? $penduduk->nik_kepala : '' }}">
                        </div>
                    </div>
                    <div class="col-md">
                        ...
                        <div class="form-group">
                            ...
                            <input type="Text" class="form-control" name="nama_user" required value="{{ isset($req_edit_kepala) ? $req_edit_kepala->nama_user : '' }}" readonly>
                            <input type="hidden" class="form-control" name="nik" required value="{{ isset($req_edit_kepala) ? $req_edit_kepala->nik_lama : '' }}">
                        </div>
                        <div class="form-group">
                            <label for="nama">NAMA KEPALA BARU</label>
                            <input type="Text" class="form-control" name="nama_kepala_baru" required value="{{ isset($req_edit_kepala) ? $req_edit_kepala->nama_kepala_baru : '' }}" readonly>
                        </div>
                        <div class="form-group">
                            <label for="nama">NIK KEPALA BARU</label>
                            <input type="Text" class="form-control" name="nik_kepala_baru" required value="{{ isset($req_edit_kepala) ? $req_edit_kepala->nik_kepala_baru : '' }}" readonly>
                        </div>
                    </div>
                </div>
                <div class="form-group">
