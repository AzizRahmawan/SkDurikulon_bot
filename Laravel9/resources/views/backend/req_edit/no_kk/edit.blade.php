...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('req_edit_no_kk.update',$req_edit_no_kk->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <div class="row">
                    <div class="col-md">
                        ...
                        <div class="form-group">
                            ...
                            <input type="Text" class="form-control" name="no_kk_lama" required value="{{ isset($penduduk) ? $penduduk->no_kk : '' }}">
                        </div>
                    </div>
                    <div class="col-md">
                        ...
                        <div class="form-group">
                            ...
                            <input type="Text" class="form-control" name="nama" required value="{{ isset($req_edit_no_kk) ? $req_edit_no_kk->nama_user : '' }}" readonly>
                            <input type="hidden" class="form-control" name="nik" required value="{{ isset($req_edit_no_kk) ? $req_edit_no_kk->nik_lama : '' }}">
                        </div>
                        <div class="form-group">
                            <label for="nama">NO KK BARU</label>
                            <input type="Text" class="form-control" name="no_kk_baru" required value="{{ isset($req_edit_no_kk) ? $req_edit_no_kk->no_kk_baru : '' }}" readonly>
                        </div>
                    </div>
                </div>
                <div class="form-group">
