...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('req_edit_tgl_lahir.update',$req_edit_tgl_lahir->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <div class="row">
                    <div class="col-md">
                        ...
                        <div class="form-group">
                            ...
                            <input type="Text" class="form-control" name="tgl_lahir_lama" required value="{{ isset($penduduk) ? $penduduk->tmpt_tgl_lahir : '' }}">
                        </div>
                    </div>
                    <div class="col-md">
                        ...
                        <div class="form-group">
                            ...
                            <input type="Text" class="form-control" name="nama_user" required value="{{ isset($req_edit_tgl_lahir) ? $req_edit_tgl_lahir->nama_user : '' }}" readonly>
                            <input type="hidden" class="form-control" name="nik" required value="{{ isset($req_edit_tgl_lahir) ? $req_edit_tgl_lahir->nik_lama : '' }}">
                        </div>
                        <div class="form-group">
                            <label for="nama">TEMPAT TANGGAL LAHIR BARU</label>
                            <input type="Text" class="form-control" name="tgl_lahir_baru" required value="{{ isset($req_edit_tgl_lahir) ? $req_edit_tgl_lahir->tgl_lahir_baru : '' }}" readonly>
                        </div>
                    </div>
                </div>
                <div class="form-group">
