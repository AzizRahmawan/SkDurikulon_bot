...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('req_edit_pendidikan.update',$req_edit_pendidikan->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <div class="row">
                    <div class="col-md">
                        ...
                        <div class="form-group">
                            ...
                            <input type="Text" class="form-control" name="pendidikan_lama" required value="{{ isset($penduduk) ? $penduduk->pendidikan : '' }}">
                        </div>
                    </div>
                    <div class="col-md">
                        ...
                        <div class="form-group">
                            ...
                            <input type="Text" class="form-control" name="nama_user" required value="{{ isset($req_edit_pendidikan) ? $req_edit_pendidikan->nama_user : '' }}" readonly>
                            <input type="hidden" class="form-control" name="nik" required value="{{ isset($req_edit_pendidikan) ? $req_edit_pendidikan->nik_lama : '' }}">
                        </div>
                        <div class="form-group">
                            <label for="nama">PENDIDIKAN TERAKHIR BARU</label>
                            <input type="Text" class="form-control" name="pendidikan_baru" required value="{{ isset($req_edit_pendidikan) ? $req_edit_pendidikan->pendidikan_baru : '' }}" readonly>
                        </div>
                    </div>
                </div>
                <div class="form-group">
