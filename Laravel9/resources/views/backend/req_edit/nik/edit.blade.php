...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('req_edit_nik.update',$req_edit_nik->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <div class="row">
                    <div class="col-md">
                        ...
                        <div class="form-group">
                            ...
                            <input type="Text" class="form-control" name="nik_lama" required value="{{ isset($penduduk) ? $penduduk->nik : '' }}">
                        </div>
                    </div>
                    <div class="col-md">
                        ...
                        <div class="form-group">
                            ...
                            <input type="Text" class="form-control" name="nama_user" required value="{{ isset($req_edit_nik) ? $req_edit_nik->nama_user : '' }}" readonly>
                            <input type="hidden" class="form-control" name="nik" required value="{{ isset($req_edit_nik) ? $req_edit_nik->nik_lama : '' }}">
                        </div>
                        <div class="form-group">
                            <label for="nama">NIK BARU</label>
                            <input type="Text" class="form-control" name="nik_baru" required value="{{ isset($req_edit_nik) ? $req_edit_nik->nik_baru : '' }}" readonly>
                        </div>
                    </div>
                </div>
                <div class="form-group">
