...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('req_edit_alamat.update',$req_edit_alamat->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <div class="row">
                    <div class="col-md">
                        ...
                        <div class="form-group">
                            <label for="nama">ALAMAT LAMA</label>
                            <textarea name="alamat_lama" class="form-control" cols="30" rows="10">{{ isset($penduduk) ? $penduduk->alamat_ktp : '' }}</textarea>
                        </div>
                    </div>
                    <div class="col-md">
                        ...
                        <div class="form-group">
                            ...
                            <input type="Text" class="form-control" name="nama_user" required value="{{ isset($req_edit_alamat) ? $req_edit_alamat->nama_user : '' }}" readonly>
                            <input type="hidden" class="form-control" name="nik" required value="{{ isset($req_edit_alamat) ? $req_edit_alamat->nik_lama : '' }}">
                        </div>
                        <div class="form-group">
                            <label for="nama">ALAMAT BARU</label>
                            <textarea name="alamat_lama" class="form-control" cols="30" rows="10" readonly>{{ isset($req_edit_alamat) ? $req_edit_alamat->alamat_baru : '' }}</textarea>
                        </div>
                    </div>
                </div>
                <div class="form-group">
